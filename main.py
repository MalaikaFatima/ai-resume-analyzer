...
if st.session_state.role == "admin":
    ...
    #     candidate_pages.show_upload_resume()
    #     # Show a table listing all uploaded resumes for this candidate
    #     # # so users can see multiple uploads below the upload form.
    #     # candidate_pages.show_uploaded_resumes()
